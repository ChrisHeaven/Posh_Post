...
if (request.getParameter("password") != null && request.getParameter("original_username") != null) {
    ...
    try {
        ...
        if (!con.isClosed()) {
            ...
            if (rs.next() == false) {
                ...
                sql = "update users_information set password = '" + password + "' where username = '" + original_username + "'";
                sql2 = "update users_state set password = '" + password + "' where username = '" + original_username + "'";
                sql3 = "update weibo set password = '" + password + "' where username = '" + original_username + "'";
