    ...
    try {
        ...
        if (!con.isClosed()) {
            ...
            if (rs.next() == false) {
                ...
                sql = "select sex, introduction from users_information where username in (select username from relations where friends in (select username from users_state where state = '1'))";
