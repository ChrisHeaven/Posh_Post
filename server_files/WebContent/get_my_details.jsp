    ...
    try {
        ...
        if (!con.isClosed()) {
            ...
            if (rs.next() == false) {
                ...
                sql = "select sex, introduction from users_information where username in (select username from test.users_state where state=1)";
                ResultSet rss = stmt.executeQuery(sql);

               // sql2 = "select username from relations where friends in (select username from test.users_state where state = 1)";
