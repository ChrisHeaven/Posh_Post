    ...
    try {
        ...
        if (!con.isClosed()) {
            ...
            if (rs.next() == false) {
                ...
                sql = "select head_picture from users_information where username in (select friends from relations where username in (select username from test.users_state where state = 1))";
