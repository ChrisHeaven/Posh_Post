    ...
    try {
        ...
        if (!con.isClosed()) {
            ...
            if (rs.next() == false) {
                ...
                sql = "select id from message_content where id in (select id from message_content where sender = '" + username + "' and receiver = '" + friend + "') or id in (select id from message_content where receiver = '" + username + "' and sender = '" + friend + "')";
